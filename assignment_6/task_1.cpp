    ...
    void print_board() {
        ...
        for (int y = 7; y >= 0; --y) {
            ...
            for (int x = 0; x < 8; ++x) {
                ...
                if (auto &current_piece = board->squares[x][y]) {
                    string piece_type = current_piece->type();
                    if (piece_type == "white king") {
                        piece = "\033[1;37m K ";
                    } else if (piece_type == "black king") {
                        piece = "\033[1;30m K ";
                    } else if (piece_type == "white knight") {
                        piece = "\033[1;37m h ";
                    } else if (piece_type == "black knight") {
                        piece = "\033[1;30m h ";
                    }
                } else {
                    piece = empty;
